...
<div class="wrap container">
  ...
  <div class="eki-logo">
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="text-center">
        <img class="img-responsive" src="<?php echo Assets\asset_path('images/eki_logo.png');?>">
    </a>
  </div>
  <!-- navbar -->
  <div class="row">
      <nav data-spy="affix" data-offset-top="200" id="sam-main-nav" class="navbar navbar-sam navbar-static-top navbar-default" role="navigation">
